...
namespace PogodaMiasta.Services
{
    public interface IWeather
    {
    Task<City[]> GetLocations(string locationName);
    Task<Weather> GetCurrentConditions(string cityKey);
    Task<string[]> GetNeighbourCities(string cityKey);
    Task<string[]> GetDetailWeather(string cityKey);
    Task<string> GetCurrentWeather(string cityKey);
    Task<string[]> GetWeatherAlert(string cityKey);
    Task<string> GetIPLocation();
    }
    internal class AccuWeatherService : IWeather
    {
