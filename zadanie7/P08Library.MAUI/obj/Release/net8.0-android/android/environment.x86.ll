...
@dso_cache = dso_local local_unnamed_addr global [612 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 43785784, ; hash 0x29c1e38, from name: libaot-P08Library.MAUI
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 110217695, ; hash 0x691c9df, from name: P08Library.MAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-P08Library.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	...
	%struct.DSOCacheEntry {
		i64 280369946, ; hash 0x10b61b1a, from name: libaot-P08Library.MAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-P08Library.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	...
	%struct.DSOCacheEntry {
		i64 369515892, ; hash 0x16065d74, from name: P06Shop.Shared.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 483606520, ; hash 0x1cd33ff8, from name: aot-P08Library.MAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-P08Library.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 68
	...
	%struct.DSOCacheEntry {
		i64 791175804, ; hash 0x2f28627c, from name: P08Library.MAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-P08Library.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 1190401951, ; hash 0x46f4179f, from name: aot-P06Shop.Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P06Shop.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 1830416150, ; hash 0x6d19ef16, from name: aot-P06Shop.Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P06Shop.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 258
	...
	%struct.DSOCacheEntry {
		i64 2690541537, ; hash 0xa05e67e1, from name: P06Shop.Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P06Shop.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 398
	...
	%struct.DSOCacheEntry {
		i64 3361638353, ; hash 0xc85e87d1, from name: libaot-P06Shop.Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P06Shop.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 494
	...
	%struct.DSOCacheEntry {
		i64 4147566830, ; hash 0xf736d8ee, from name: libaot-P06Shop.Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P06Shop.Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 591
	...
	%struct.DSOCacheEntry {
		i64 4183735735, ; hash 0xf95ebdb7, from name: aot-P08Library.MAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-P08Library.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 597
